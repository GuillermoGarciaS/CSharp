...
class Tarea_1
{
    static void Main()
    {
        ...
        Console.WriteLine($"Aqui estan los numeros sumados {Opera_1}");
        Console.WriteLine($"Aqui estan los numeros multiplicados {Opera_2}");
        Console.WriteLine($"Ahora mostraremos el residuo de la division de los dos ultimos numeros {Opera_3}");
        ...
        if (contraste_1 == true && contraste_2 == true) {
        ...
        else if (contraste_1 == false && contraste_2 == false) {

            contraste_3 = false;
            Console.WriteLine($"Dado que {contraste_1} y {contraste_2} no se cumplen, el resultado es {contraste_3}");
            ...
            contraste_3 = false;
            Console.WriteLine($"Dado que el 1er contraste o o el 2do contraste no se cumple, el resultado es {contraste_3}");
